...
import { BarChart3, BriefcaseBusiness, LayoutDashboard, LogOut, MessageCircle, PanelLeft, Users } from "lucide-react";
...
const menuItems = [
  ...
  { icon: MessageCircle, label: "Configuración", path: "/admin/config" },
];
